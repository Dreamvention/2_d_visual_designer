...
class ControllerModuleDVisualDesigner extends Controller {
	...
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->model_module_d_visual_designer->getGroupId(), 'modify', $this->codename.'/template');
		$this->model_user_user_group->addPermission($this->model_module_d_visual_designer->getGroupId(), 'access', $this->codename.'/instruction');
