function vd_sortable(options) {
        ...
        for(var key in this.allowZones) {
            ...
            container.on("mouseenter", function (event) {
                if(this.dragging){
                    ...
                    this.store.dispatch('block/placeholder/show', {designer_id: options.designer_id, block_id: underId})
            ...
            container.on("mouseleave", function (event) {
                if(this.dragging) {
                    var underId = $(event.currentTarget).data('id')
                    this.store.dispatch('block/placeholder/hide', {designer_id: options.designer_id, block_id: underId})
    ...
    **/
    this.store.subscribe('sortable/end', function(data){
        ...
        this.store.dispatch('block/move', {block_id: this.drag_id, target: this.under_id, designer_id: options.designer_id, sort_order: data.sort_order, success: function(){
            var drag = this.store.getState().drag
