<vd-setting-block-row_inner>
    <div class="form-group">
        <label class="control-label">{store.getLocal('blocks.row_inner.entry_background_video')}</label>
        <div class="fg-setting">
            <vd-switcher name="background_video" value="{setting.global.background_video}" evchange={change}/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label">{store.getLocal('blocks.row_inner.entry_video_link')}</label>
        <div class="fg-setting">
